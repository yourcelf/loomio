module Loomio
  module I18n
    ...
    SELECTABLE_LOCALES = %i( en an be-BY bg-BG ca cs zh-TW da de eo es el fr id it hu ja ko ml nl-NL pt-BR ro sr sr-RS sk sv vi tr uk )
    ...
    TEST_LOCALES = %i( ar cmn hr fi gl ga-IE he km mk mi fa-IR pl pt-PT ru sl te ur ur-PK )
